...
/**
 * @Author Timor
 * @Date 2023/12/22 20:45
 * @Version 1.0
 */
public class Tm_PhoenixConnectPool {
    ...
    static {
        ...
        // 设置驱动全类名
        druidDataSource.setDriverClassName(A1_ConfigProperty.PHOENIX_DRIVER);
        // 设置连接 url
        druidDataSource.setUrl(A1_ConfigProperty.PHOENIX_URL);
        // 设置初始化连接池时池中连接的数量
        ...
        System.out.println("phoenix线程池初始化");
    }
