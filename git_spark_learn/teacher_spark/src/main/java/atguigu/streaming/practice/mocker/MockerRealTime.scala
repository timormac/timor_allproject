package atguigu.streaming.practice.mocker

import java.util.{Properties, Random}

import com.atguigu.practice.bean.CityInfo
import com.atguigu.practice.utils.{PropertiesUtil, RanOpt, RandomOptions}
