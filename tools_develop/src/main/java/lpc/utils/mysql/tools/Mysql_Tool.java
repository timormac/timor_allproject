...
public class Mysql_Tool {
    ...
    static {
        ...
        druidDataSource.setDriverClassName(Mysql_ConfigProperty.MYSQL_DRIVER);
        druidDataSource.setUrl(Mysql_ConfigProperty.MYSQL_URL);
        druidDataSource.setUsername(Mysql_ConfigProperty.MYSQL_USER);
        druidDataSource.setPassword(Mysql_ConfigProperty.MYSQL_PASSWORD);
    ...
    public static ArrayList<Mysql_Dao> tableQueryset(Connection connect, String tb, String clsName, String filterCondition) throws Exception {
        ...
        ArrayList<Mysql_Dao> mysqlDao_arr = new ArrayList<>();
        ...
        while ( resultSet.next() ){
            ...
            Mysql_Dao mysqlDao = (Mysql_Dao) object ;
            mysqlDao.getInstance(daoMap);
            mysqlDao_arr.add(mysqlDao);
        }
    ...
    public static void insertTableDaoList(Connection connect, String tb, String clsName, List<Mysql_Dao> mysqlDaoList) throws Exception {
      ...
      // System.out.println( sql );
        ...
        for (Mysql_Dao mysqlDao : mysqlDaoList) {
            //检测dao是不是真的cls实例
            if( !(clazz.isInstance(mysqlDao)) ) {
                throw new Exception("实例错误");
            }
            Object cast = clazz.cast(mysqlDao);
