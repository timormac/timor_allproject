...
public class Mysql_JdbcTool {
    ...
    public Mysql_JdbcTool(String driver, String url, String user, String password) {
    ...
    //  默认是msyq,读取配置文件
    public Mysql_JdbcTool() {
        this(
                Mysql_ConfigProperty.MYSQL_DRIVER,
                Mysql_ConfigProperty.MYSQL_URL,
                Mysql_ConfigProperty.MYSQL_USER,
                Mysql_ConfigProperty.MYSQL_PASSWORD
        );
